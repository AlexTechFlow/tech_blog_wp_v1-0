<?php
/**
 * Digital Health Blog functions and definitions
 *
...
if ( ! function_exists( 'digital_health_blog_setup' ) ) :
	/**
	 ...
	 */
	function digital_health_blog_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on Digital Health Blog, use a find and replace
		 * to change 'digital-health-blog' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'digital-health-blog', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'primary' => esc_html__( 'Primary', 'digital-health-blog' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'digital_health_blog_custom_background_args', array(
 ...
 */
function digital_health_blog_content_width() {
...
add_action( 'wp_enqueue_scripts', 'digital_health_blog_scripts' );
